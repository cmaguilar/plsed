...
/*  Modal del panel  */
	function bodyModalPanel(id){ 
		document.getElementById(id).addEventListener('click', function(){ document.body.className = document.body.className + ' modalPanel'; }, false);
	};
	bodyModalPanel('edit-portada');
	bodyModalPanel('edit-foto');
	bodyModalPanel('edit-data');
	bodyModalPanel('edit-gale');
	bodyModalPanel('edit-data-nav');
	bodyModalPanel('edit-gale-nav');
